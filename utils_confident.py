...
def construct_prompt(example, data_name, args):
    ...
    # SFT models
        ...
        full_prompt = full_prompt.format(input=example['question'])
    elif args.prompt_type == 'simpleTIR':
        full_prompt = "Solve the following problem step by step. You now have the ability to selectively write executable Python code to enhance your reasoning process. The Python code will be executed by an external sandbox, and the output (after '\\n```output\\n') is returned to aid your reasoning and help you arrive at the final answer. The Python code should be complete scripts, including necessary imports.\nCode Format:\n Each code snippet is wrapped between \\n```python \\n```.\\n You need to use `print()` to output intermediate results.The code execution result is only auxiliary, you can choose to believe or not believe it.\nAnswer Format:\nYou should use \\boxed to return your final answer. The last part of your response should be:\n\\boxed{{'The final answer goes here.'}}\nUser Question:\n{input}"
        full_prompt = full_prompt.format(input=example['question'])
    elif args.prompt_type == 'DemyAgent':
        full_prompt = "Please solve the following problem step by step. During your reasoning process, if needed, you can choose to write python code to enhance your reasoning.You need to use `print()` to output intermediate results.The code executor will run your code and provide the execution results back to you to support your reasoning process.\nA Python code block and its execution result strictly follow the following format:\n```python\n#your code here\n```\n```output\nexecution result here\n```\n Please put the final answer within \\boxed{{}}.\nQuestion:\n{input}"
        full_prompt = full_prompt.format(input=example['question'])
    elif args.prompt_type == 'EffectiveCIR':
        full_prompt = "Please solve the following problem step by step. During your reasoning process, if needed, you can choose to write python code to enhance your reasoning. The code executor will run your code and provide the execution results (after '\\n```output\\n') back to you to support your reasoning process. Please put the final answer within \\boxed{{}}.The code execution result is only auxiliary, you can choose to believe or not believe it.\nQuestion:\n{input}"
        full_prompt = full_prompt.format(input=example['question'])
