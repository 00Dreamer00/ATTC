...
PROMPT_TYPE="simpleTIR"
MODEL_NAMES=(
    # /public/home/ljt/xrt/model/ToRL-7B
    # /workspace/mnt/xrt/model/Qwen2.5-7B-SimpleTIR
    /workspace/mnt/xrt/model/Qwen2.5-32B-SimpleTIR
...
# DATA_NAMES="minerva_math,aime24,amc23"
DATA_NAMES="math500,olympiadbench,minerva_math,aime24,amc23"
# DATA_NAMES="math500"
SPLIT="test"
NUM_TEST_SAMPLE=-1
